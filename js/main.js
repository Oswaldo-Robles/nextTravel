...
window.SERVICIOURL = "http://localhost/ServicioWebEP1";
...
const activarLink = (link) => {
    menuMain.querySelectorAll("a.nav-link, a.dropdown-item").forEach(a => a.classList.remove("active"));
    link.classList.add("active");

    if (link.classList.contains("dropdown-item")) {
        let parentDropdown = link.closest(".dropdown").querySelector(".dropdown-toggle");
